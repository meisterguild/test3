...
要件定義ドラフトの AC-01〜AC-06（通しシナリオ）は E2E で検証する（[#12](https://github.com/meisterguild/test3/issues/12) で確定）。本 spec の AC との対応は次のとおり。

| 要件 AC | 本 spec の AC |
| --- | --- |
| AC-01（次の果物が見える） | AC-8 / AC-10 |
| AC-03（合体してスコアが増える） | AC-2 / AC-3 / AC-13 |
| AC-04（満杯でゲームオーバー） | AC-11 / AC-12 |
...
- test: `tests/unit/merge.test.ts > [game-core-rules:R-1]`
